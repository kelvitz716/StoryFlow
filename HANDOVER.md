...
│   ├── __init__.py
│   └── snapchat.py         # Custom Snapchat API downloader
...
- **gallery-dl & yt-dlp**: Core engines for media extraction.
...
- **Snapchat**: Currently uses a custom API wrapper. Public stories only.
