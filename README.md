...
- **Snapchat Support**: Direct scraping of `story.snapchat.com` — no API keys or external accounts required. Downloads active stories and highlight albums from public profiles.
